...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 19, 2025 at 11:58 AM
...
(281, 110, '2025-12-19 10:27:10', 'เทสงานระบบบเเจเ้งซ่อมจอฟ้าดับ คอมพัง เครื่องปริิ้่นพัง น้ำไม่ไหล ไฟดับ หนูกัดสายไฟ เตาไฟฟ้าไม่ทำงาน', 'chavanlak.p@ku.th', 'example@mail.com', 'ยังไม่ปิดงาน', NULL, 'FQ01');
...
(2, 230, '', '2025-11-21 15:09:15'),
(3, 230, 'กำลังดำเนินการซ่อม | ช่างStore', '2025-11-21 15:09:54'),
(4, 230, '', '2025-11-21 15:10:15'),
(5, 231, '', '2025-11-24 14:00:25'),
(6, 232, '', '2025-11-25 11:35:25'),
(7, 231, 'กำลังดำเนินการซ่อม | ช่างStore', '2025-12-09 15:34:37'),
(8, 264, '', '2025-12-09 15:36:17'),
(9, 265, '', '2025-12-09 15:42:08'),
(10, 266, '', '2025-12-09 15:42:14'),
(11, 265, '', '2025-12-09 15:44:50'),
(12, 266, 'กำลังดำเนินการซ่อม | ช่างStore', '2025-12-09 15:49:11'),
(13, 266, '', '2025-12-09 15:49:57'),
(14, 264, 'กำลังดำเนินการซ่อม | ช่างStore', '2025-12-09 16:13:22'),
(15, 275, '', '2025-12-17 15:12:43'),
(16, 276, '', '2025-12-17 15:42:52'),
(17, 277, '', '2025-12-17 16:00:05'),
(18, 280, '', '2025-12-17 17:25:49'),
(19, 280, '', '2025-12-19 15:43:50'),
(20, 281, 'ได้รับของแล้ว', '2025-12-19 17:30:37'),
(21, 281, 'ส่งSuplierแล้ว', '2025-12-19 17:44:09'),
(22, 281, 'ซ่อมงานเสร็จแล้ว | Supplier', '2025-12-19 17:44:25');
...
--
ALTER TABLE `fileupload`
  MODIFY `FileUploadId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=422;

--
-- AUTO_INCREMENT for table `notirepair`
--
ALTER TABLE `notirepair`
  MODIFY `NotirepairId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=282;

--
-- AUTO_INCREMENT for table `statustracking`
--
ALTER TABLE `statustracking`
  MODIFY `statustrackingId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
