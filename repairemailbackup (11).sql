...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 26, 2025 at 11:49 AM
...
(280, 110, '2025-12-17 10:20:37', '- ไม่มีเมลสาขาด้วย \r\n- BM ไม่อัพเดทด้วยเเหละว้าววววววววววววววววววววววววววววววววววววววววววววววววว\r\n- ต้องเเก้ใหม่อีกเชื่อดิ', 'chavanlak.p@ku.th', 'example@mail.com', 'ยังไม่ปิดงาน', NULL, 'FQ01', NULL),
(281, 110, '2025-12-19 10:27:10', 'เทสงานระบบบเเจเ้งซ่อมจอฟ้าดับ คอมพัง เครื่องปริิ้่นพัง น้ำไม่ไหล ไฟดับ หนูกัดสายไฟ เตาไฟฟ้าไม่ทำงาน', 'chavanlak.p@ku.th', 'example@mail.com', 'ยังไม่ปิดงาน', NULL, 'FQ01', NULL),
(282, 110, '2025-12-22 07:47:23', 'จอฟ้า', 'chavanlak.p@ku.th', 'example@mail.com', 'ยังไม่ปิดงาน', NULL, 'FQ01', NULL),
(283, 110, '2025-12-22 07:48:09', 'คอมพัง', 'chavanlak.p@ku.th', 'example@mail.com', 'ยังไม่ปิดงาน', NULL, 'FQ01', NULL),
(284, 110, '2025-12-22 07:49:48', '- เทส1\r\n- เทส2 \r\n- เทส 3', 'chavanlak.p@ku.th', 'example@mail.com', 'ปิดงานเรียบร้อย', '2025-12-22 14:51:52', 'FQ01', NULL),
(285, 112, '2025-12-22 07:50:47', 'วอลเปเปอร์พัง', 'chavanlak.p@ku.th', 'repaircentertgi@gmail.com', 'ยังไม่ปิดงาน', NULL, 'C01', NULL),
...
(287, 110, '2025-12-24 10:56:35', 'ssss', 'chavanlak.p@ku.th', 'example@mail.com', 'ยังไม่ปิดงาน', NULL, 'F05', 'MRO-F05-20251224-001');
...
CREATE TABLE `statustracking` (
  ...
  `NotirepairId` int(11) NOT NULL,
  `status` enum('ยังไม่ได้รับของ','ได้รับของแล้ว','ส่งSuplierแล้ว','กำลังดำเนินการซ่อม | ช่างStore','ซ่อมงานเสร็จแล้ว | ช่างStore','ซ่อมงานเสร็จแล้ว | Supplier') NOT NULL DEFAULT 'ยังไม่ได้รับของ',
...
--
ALTER TABLE `fileupload`
  MODIFY `FileUploadId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=428;

--
-- AUTO_INCREMENT for table `notirepair`
--
ALTER TABLE `notirepair`
  MODIFY `NotirepairId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=288;

--
-- AUTO_INCREMENT for table `statustracking`
--
ALTER TABLE `statustracking`
  MODIFY `statustrackingId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
